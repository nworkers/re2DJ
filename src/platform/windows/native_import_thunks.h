#ifndef RE2DJ_PLATFORM_WINDOWS_NATIVE_IMPORT_THUNKS_H_
#define RE2DJ_PLATFORM_WINDOWS_NATIVE_IMPORT_THUNKS_H_
...
#endif  // RE2DJ_PLATFORM_WINDOWS_NATIVE_IMPORT_THUNKS_H_
